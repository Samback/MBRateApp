...
open class MBRateUs{
    ...
    open func showRateUs(_ base:UIViewController, positiveBlock:@escaping ()->Void, negativeBlock:@escaping ()->Void, dismissBlock:(()->Void)? = nil, iconAnimationBlock:((_ iconView: UIImageView)->Void)? = nil ){
